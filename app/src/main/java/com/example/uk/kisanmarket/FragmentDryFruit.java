...
public class FragmentDryFruit extends Fragment {

    private static final String P_SUB_CATEGORY = "Dry Fruit";

    public List<Product> productArrayList;
    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;
    View view;
    public FragmentDryFruit() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_dry_fruit, container, false);
        downloadProduct();
        return view;
    }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewDryFruit);
