...
public class FragmentWheat extends Fragment {
    ...
    private static final String P_SUB_CATEGORY = "Wheat";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_wheat, container, false);
        downloadProduct();
        return view;
    }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewWheat);
